...
INGREIDENTS_URL = reverse('recipe:ingredient-list')
...
class PublicIngredientsApiTests(TestCase):
    ...
    def test_auth_require(self):
        ...
        res = self.client.get(INGREIDENTS_URL)
...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_update_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Lemongrass')

        payload = {'name': 'Rosemary'}
    ...
    def filter_ingredients_assigned_to_recipes(self):
        ...
        ing2 = Ingredient.objects.create(self.user, name="Turkey")
        ...
        res = self.client.get(INGREIDENTS_URL, {'assigned_only': 1})
